...
class SubscriptionIntegrationTest {
    ...
    private Subscription subscription100;
    private Subscription subscription200;
    private SubscriptionDto subscriptionDto1;
    private SubscriptionDto subscriptionDto2;
    private SubscriptionDto subscriptionDto3;
    ...
    void setUp() {
        ...
        subscription100 = new Subscription();
        subscription100.setId(1L);
        subscription100.setTypeSubscription("annual");
        subscription100.setExpirationDate(LocalDate.of(2023, 11, 30));
        subscription100 = subscriptionRepository.save(subscription100);

        subscription200 = new Subscription();
        subscription200.setId(2L);
        subscription200.setTypeSubscription("annual");
