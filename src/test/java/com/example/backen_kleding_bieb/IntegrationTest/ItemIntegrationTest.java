...
public class ItemIntegrationTest {
    ...
    void setUp() {
        ...
        item100 = new Item();
        item100.setUsers(user1);
        item100.setNameInfo("blouse");
        item100 = itemRepository.save(item100);

        item200 = new Item();
        item200.setUsers(user2);
        item200.setNameInfo("hat");
        item200 = itemRepository.save(item200);

        itemDto1 = new ItemDto(item100.getId(), "blouse", null, user1, null);
        itemDto2 = new ItemDto(item200.getId(), "hat", null, user2, null);
        itemDto3 = new ItemDto(2L, "hat", null, user2, null);
    }
